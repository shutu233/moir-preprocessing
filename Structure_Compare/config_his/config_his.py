def Configure_Histogram(at1, at2, layer_1, layer_2):
    '''
    Args:
    at1: 1st atoms structure
    at2: 2nd atoms structure
    layer_1: unitcell of 1st layer
    layer_2: unitcell of 2nd layer

    Returns:
    A figure of histogram of at1 & at2
    '''
    ...
    plt.tight_layout()
    plt.savefig("histograms_6x1.png", dpi=300, bbox_inches="tight")
    plt.show()